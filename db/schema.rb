...
ActiveRecord::Schema.define(version: 2019_08_28_124658) do
  ...
  create_table "users_models", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_users_models_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_models_on_reset_password_token", unique: true
  end
